...
def arg_parse():
    ...
    arg.add_argument('videopath1',type=str)
    arg.add_argument('videopath2',type=str)
    arg.add_argument('--filename',type=str,default='/home/chunhung/tracking/concat_camera.mp4')
